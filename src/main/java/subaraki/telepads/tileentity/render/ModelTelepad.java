...
public class ModelTelepad extends Model {
    ...
    RendererModel frame;
    RendererModel arrows;
    RendererModel legWestRight;
    RendererModel legWestLeft;
    RendererModel legEastRight;
    RendererModel legEastLeft;
    RendererModel legSouthRight;
    RendererModel legSouthLeft;
    RendererModel legNorthRight;
    RendererModel legNorthLeft;

    RendererModel antenna;
    RendererModel antennaPad;
    ...
    public ModelTelepad() {
        ...
        antenna = new RendererModel(this, 0, 27);
        ...
        antennaPad = new RendererModel(this, 4, 28);
        ...
        frame = new RendererModel(this, 0, 0);
        ...
        arrows = new RendererModel(this, 0, 11);
        ...
        legWestRight = new RendererModel(this, 0, 0);
        ...
        legWestLeft = new RendererModel(this, 0, 0);
        ...
        legEastLeft = new RendererModel(this, 0, 0);
        ...
        legEastRight = new RendererModel(this, 0, 0);
        ...
        // legSouthRight = new RendererModel(this, 0, 0);
        ...
        //
        // legSouthLeft = new RendererModel(this, 0, 0);
        ...
        // legNorthRight = new RendererModel(this, 0, 0);
        ...
        //
        // legNorthLeft = new RendererModel(this, 0, 0);

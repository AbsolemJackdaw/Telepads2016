...
public class TelepadItems {
    ...
    public static final RegistryObject<Item> TELEPAD = ITEMS.register("telepad", () ->
            new BlockItem(TelepadBlocks.TELEPAD.get(), new Item.Properties()) {
    ...
    public static final RegistryObject<Item> TOGGLER = ITEMS.register("toggler", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> TRANSMITTER = ITEMS.register("transmitter", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> CYCLE_ROD = ITEMS.register("creative_rod", () -> new Item(new Item.Properties()) {
        @Override
        public void appendHoverText(ItemStack stack, Level worldIn, List<Component> tooltip, TooltipFlag flagIn) {
    ...
    public static final RegistryObject<Item> PUBLIC_TOGGLE_ROD = ITEMS.register("creative_rod_public", () -> new Item(new Item.Properties()) {
        @Override
        public void appendHoverText(ItemStack stack, Level worldIn, List<Component> tooltip, TooltipFlag flagIn) {

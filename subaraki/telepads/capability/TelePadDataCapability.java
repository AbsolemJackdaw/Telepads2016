...
public class TelePadDataCapability {
	...
	public static class StorageHelper implements Capability.IStorage<TelepadData>{
		...
		@Override
		public NBTBase writeNBT(Capability<TelepadData> capability, TelepadData instance, EnumFacing side)		{
			return instance.writeData();
		}

		@Override
		public void readNBT(Capability<TelepadData> capability, TelepadData instance, EnumFacing side, NBTBase nbt){
